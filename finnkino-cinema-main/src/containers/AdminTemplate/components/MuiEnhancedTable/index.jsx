...
function MuiEnhancedTable(props) {
  const { tableType, loading, headCells, TableCellList, pageProps, rowsPerPageProps, onChangePage, onChangeSizePage, onChangeRowsPerPage, handleSearch } = props;
  let { dataList } = props;
  ...
  const emptyRows = pageProps > 0 ? Math.max(0, (1 + pageProps) * rowsPerPageProps - rows.length) : 0;
  return (
    <>
      {loading ? (
        <Loader />
        ...
        <Fragment>
          <Box sx={{ width: "100%" }}>
            <Paper sx={{ width: "100%", mb: 2 }}>
                ...
                >
                  ...
                  <TableBody>
                    {stableSort(rows, getComparator(order, orderBy))
                      .slice(pageProps * rowsPerPageProps, pageProps * rowsPerPageProps + rowsPerPageProps)
                      .map((row, index) => {
              ...
              <TablePagination
                ...
                component="div"
                count={rows.length || 0}
                rowsPerPage={rowsPerPageProps || 5}
                page={pageProps || 0}
          ...
          <UserModal
            ...
            setOpenModalUser={onChangeUserModal}
